 ...
 * ```
 */
export declare class VirtualNetworkDnsServers extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualNetworkDnsServersState, opts?: pulumi.CustomResourceOptions): VirtualNetworkDnsServers;
    /**
     * Returns true if the given object is an instance of VirtualNetworkDnsServers.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VirtualNetworkDnsServers;
    /**
