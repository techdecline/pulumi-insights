...
exports.getLinuxWebAppOutput = exports.getLinuxWebApp = void 0;
 ...
 * ```
 */
function getLinuxWebApp(args, opts) {
...
exports.getLinuxWebApp = getLinuxWebApp;
/**
 * Use this data source to access information about an existing Linux Web App.
 *
 * ## Example Usage
 ...
 * ```
 */
function getLinuxWebAppOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getLinuxWebAppOutput = getLinuxWebAppOutput;
//# sourceMappingURL=getLinuxWebApp.js.map