 ...
 * ```
 */
export declare class CertificateBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertificateBindingState, opts?: pulumi.CustomResourceOptions): CertificateBinding;
    /**
     * Returns true if the given object is an instance of CertificateBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CertificateBinding;
    /**
     ...
     */
    readonly hostnameBindingId: pulumi.Output<string>;
    /**
