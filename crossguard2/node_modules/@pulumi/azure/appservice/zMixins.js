...
function produceDeploymentArchiveAsync(args) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        map["host.json"] = new pulumi.asset.StringAsset(JSON.stringify(Object.assign({ version: "2.0", tracing: { consoleLevel: "verbose" }, extensionBundle: {
                ...
                version: extentionBundleVersion.get(((_a = args.version) === null || _a === void 0 ? void 0 : _a.toString()) || "~4")
            } }, args.hostSettings)));
...
function createFunctionAppParts(name, args, opts = {}) {
    ...
    const functionArgs = Object.assign(Object.assign(Object.assign({}, args), resourceGroupArgs), { appServicePlanId: plan.id, storageAccountName: account.name, storageAccountAccessKey: account.primaryAccessKey, version: args.version || "~4", appSettings: pulumi.output(args.appSettings).apply(settings => {
            return Object.assign(Object.assign({}, settings), { WEBSITE_RUN_FROM_PACKAGE: codeBlobUrl, WEBSITE_NODE_DEFAULT_VERSION: util.ifUndefined(args.nodeVersion, "~14") });
        }) });
...
class CallbackFunctionApp extends functionApp_1.FunctionApp {
    constructor(name, bindingsOrFunc, args, opts = {}) {
        ...
        const parts = createFunctionAppParts(name, Object.assign(Object.assign({}, args), { resourceGroupName: (_a = args.resourceGroupName) !== null && _a !== void 0 ? _a : (_b = args.account) === null || _b === void 0 ? void 0 : _b.resourceGroupName, archive: produceDeploymentArchive(Object.assign(Object.assign({}, args), { functions })), appSettings: combineFunctionAppSettings(Object.assign(Object.assign({}, args), { functions })) }), opts);
