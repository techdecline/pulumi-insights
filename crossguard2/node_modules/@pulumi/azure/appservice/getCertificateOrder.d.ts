 ...
 * ```
 */
export declare function getCertificateOrderOutput(args: GetCertificateOrderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateOrderResult>;
/**
 * A collection of arguments for invoking getCertificateOrder.
 */
