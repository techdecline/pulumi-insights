 ...
 * ```
 */
export declare class ActiveSlot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActiveSlotState, opts?: pulumi.CustomResourceOptions): ActiveSlot;
    /**
     * Returns true if the given object is an instance of ActiveSlot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ActiveSlot;
    /**
     ...
     */
    readonly appServiceSlotName: pulumi.Output<string>;
    /**
