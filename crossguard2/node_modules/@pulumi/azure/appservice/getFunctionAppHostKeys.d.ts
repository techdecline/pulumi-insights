 ...
 * ```
 */
export declare function getFunctionAppHostKeysOutput(args: GetFunctionAppHostKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFunctionAppHostKeysResult>;
/**
 * A collection of arguments for invoking getFunctionAppHostKeys.
 */
