 ...
 * ```
 */
export declare class SlotVirtualNetworkSwiftConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SlotVirtualNetworkSwiftConnectionState, opts?: pulumi.CustomResourceOptions): SlotVirtualNetworkSwiftConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is SlotVirtualNetworkSwiftConnection;
    /**
     ...
     */
    readonly slotName: pulumi.Output<string>;
    /**
