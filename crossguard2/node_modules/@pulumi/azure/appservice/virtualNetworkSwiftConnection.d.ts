 ...
 * ```
 */
export declare class VirtualNetworkSwiftConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualNetworkSwiftConnectionState, opts?: pulumi.CustomResourceOptions): VirtualNetworkSwiftConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualNetworkSwiftConnection;
    /**
