...
export interface DurableActivityFunctionContext<TActivityInputBinding extends {
    [key: string]: any;
}> extends mod.Context<mod.Result> {
    bindings: TActivityInputBinding;
}
export interface DurableActivityFunctionArgs<TActivityInputBinding extends {
    [key: string]: any;
}> extends mod.CallbackFunctionArgs<DurableActivityFunctionContext<TActivityInputBinding>, void, mod.Result> {
    activityInputName: keyof TActivityInputBinding;
}
/**
 * Azure Durable Activity Function
 */
export declare class DurableActivityFunction<TActivityInputBinding extends {
    [key: string]: any;
}> extends mod.Function<DurableActivityFunctionContext<TActivityInputBinding>, void, mod.Result> {
