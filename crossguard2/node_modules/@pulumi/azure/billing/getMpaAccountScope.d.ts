 ...
 * ```
 */
export declare function getMpaAccountScopeOutput(args: GetMpaAccountScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMpaAccountScopeResult>;
/**
 * A collection of arguments for invoking getMpaAccountScope.
 */
