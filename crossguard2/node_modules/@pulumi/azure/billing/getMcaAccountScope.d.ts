 ...
 * ```
 */
export declare function getMcaAccountScope(args: GetMcaAccountScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetMcaAccountScopeResult>;
/**
 ...
 * ```
 */
export declare function getMcaAccountScopeOutput(args: GetMcaAccountScopeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMcaAccountScopeResult>;
/**
 * A collection of arguments for invoking getMcaAccountScope.
 */
