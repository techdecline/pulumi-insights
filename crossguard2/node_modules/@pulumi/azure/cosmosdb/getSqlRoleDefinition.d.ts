 ...
 * ```
 */
export declare function getSqlRoleDefinition(args: GetSqlRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlRoleDefinitionResult>;
/**
 ...
 * ```
 */
export declare function getSqlRoleDefinitionOutput(args: GetSqlRoleDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlRoleDefinitionResult>;
/**
 * A collection of arguments for invoking getSqlRoleDefinition.
 */
