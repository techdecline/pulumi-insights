 ...
 * ```
 */
export declare class SqlFunction extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlFunctionState, opts?: pulumi.CustomResourceOptions): SqlFunction;
    /**
     * Returns true if the given object is an instance of SqlFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SqlFunction;
    /**
