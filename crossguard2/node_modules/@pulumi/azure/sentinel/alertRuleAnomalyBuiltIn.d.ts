 ...
 * ```
 */
export declare class AlertRuleAnomalyBuiltIn extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertRuleAnomalyBuiltInState, opts?: pulumi.CustomResourceOptions): AlertRuleAnomalyBuiltIn;
    /**
     * Returns true if the given object is an instance of AlertRuleAnomalyBuiltIn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AlertRuleAnomalyBuiltIn;
    /**
     ...
     */
    readonly multiSelectObservations: pulumi.Output<outputs.sentinel.AlertRuleAnomalyBuiltInMultiSelectObservation[]>;
    /**
     ...
     */
    readonly prioritizedExcludeObservations: pulumi.Output<outputs.sentinel.AlertRuleAnomalyBuiltInPrioritizedExcludeObservation[]>;
    /**
     * A `requiredDataConnector` block as defined below.
     */
    readonly requiredDataConnectors: pulumi.Output<outputs.sentinel.AlertRuleAnomalyBuiltInRequiredDataConnector[]>;
    /**
     ...
     */
    readonly singleSelectObservations: pulumi.Output<outputs.sentinel.AlertRuleAnomalyBuiltInSingleSelectObservation[]>;
    /**
     ...
     */
    readonly thresholdObservations: pulumi.Output<outputs.sentinel.AlertRuleAnomalyBuiltInThresholdObservation[]>;
    /**
