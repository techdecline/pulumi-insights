...
export declare class ThreatIntelligenceIndicator extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ThreatIntelligenceIndicatorState, opts?: pulumi.CustomResourceOptions): ThreatIntelligenceIndicator;
    /**
     ...
     */
    readonly confidence: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly defanged: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly externalLastUpdatedTimeUtc: pulumi.Output<string>;
    /**
     * One or more `externalReference` blocks as defined below.
     */
    readonly externalReferences: pulumi.Output<outputs.sentinel.ThreatIntelligenceIndicatorExternalReference[] | undefined>;
    /**
     * One or more `granularMarking` blocks as defined below.
     */
    readonly granularMarkings: pulumi.Output<outputs.sentinel.ThreatIntelligenceIndicatorGranularMarking[] | undefined>;
    /**
     ...
     */
    readonly indicatorTypes: pulumi.Output<string[]>;
    /**
     * One or more `killChainPhase` blocks as defined below.
     */
    readonly killChainPhases: pulumi.Output<outputs.sentinel.ThreatIntelligenceIndicatorKillChainPhase[] | undefined>;
    /**
     ...
     */
    readonly lastUpdatedTimeUtc: pulumi.Output<string>;
    /**
     * Specifies a list of Threat Intelligence marking references.
     */
    readonly objectMarkingRefs: pulumi.Output<string[] | undefined>;
    /**
     * A `parsedPattern` block as defined below.
     */
    readonly parsedPatterns: pulumi.Output<outputs.sentinel.ThreatIntelligenceIndicatorParsedPattern[]>;
    /**
     ...
     */
    readonly patternVersion: pulumi.Output<string | undefined>;
    /**
     * Whether the Threat Intelligence entity revoked.
     */
    readonly revoked: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly threatTypes: pulumi.Output<string[] | undefined>;
    /**
     * The start of validate date in RFC3339.
     */
    readonly validateFromUtc: pulumi.Output<string>;
    /**
     * The end of validate date of the Threat Intelligence Indicator in RFC3339 format.
     */
    readonly validateUntilUtc: pulumi.Output<string | undefined>;
    /**
