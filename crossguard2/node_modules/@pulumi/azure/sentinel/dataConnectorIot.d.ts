 ...
 * ```
 */
export declare class DataConnectorIot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorIotState, opts?: pulumi.CustomResourceOptions): DataConnectorIot;
    /**
     * Returns true if the given object is an instance of DataConnectorIot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnectorIot;
    /**
