 ...
 * ```
 */
export declare function getBlob(args: GetBlobArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobResult>;
/**
 ...
 * ```
 */
export declare function getBlobOutput(args: GetBlobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBlobResult>;
/**
 * A collection of arguments for invoking getBlob.
 */
