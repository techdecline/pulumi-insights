 ...
 * ```
 */
export declare class VaultResourceGuardAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VaultResourceGuardAssociationState, opts?: pulumi.CustomResourceOptions): VaultResourceGuardAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is VaultResourceGuardAssociation;
    /**
     * ID of the Resource Guard which should be associated with. Changing this forces a new resource to be created.
     */
    readonly resourceGuardId: pulumi.Output<string>;
    /**
