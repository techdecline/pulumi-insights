 ...
 * ```
 */
export declare class TenantTemplateDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TenantTemplateDeploymentState, opts?: pulumi.CustomResourceOptions): TenantTemplateDeployment;
    /**
     * Returns true if the given object is an instance of TenantTemplateDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TenantTemplateDeployment;
    /**
