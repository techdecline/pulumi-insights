 ...
 * ```
 */
export declare function getExtendedLocationsOutput(args: GetExtendedLocationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExtendedLocationsResult>;
/**
 * A collection of arguments for invoking getExtendedLocations.
 */
