 ...
 * ```
 */
export declare function getCertificateIssuerOutput(args: GetCertificateIssuerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateIssuerResult>;
/**
 * A collection of arguments for invoking getCertificateIssuer.
 */
