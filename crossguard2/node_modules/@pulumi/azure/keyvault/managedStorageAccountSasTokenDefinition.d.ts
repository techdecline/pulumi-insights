 ...
 * ```
 */
export declare class ManagedStorageAccountSasTokenDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedStorageAccountSasTokenDefinitionState, opts?: pulumi.CustomResourceOptions): ManagedStorageAccountSasTokenDefinition;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedStorageAccountSasTokenDefinition;
    /**
     * The ID of the Managed Storage Account.
     */
    readonly managedStorageAccountId: pulumi.Output<string>;
    /**
     ...
     */
    readonly validityPeriod: pulumi.Output<string>;
    /**
