...
export declare class CustomDomain extends pulumi.CustomResource {
     ...
     */
    readonly developerPortals: pulumi.Output<outputs.apimanagement.CustomDomainDeveloperPortal[] | undefined>;
    /**
     * One or more `gateway` blocks as defined below.
     */
    readonly gateways: pulumi.Output<outputs.apimanagement.CustomDomainGateway[] | undefined>;
    /**
     * One or more `management` blocks as defined below.
     */
    readonly managements: pulumi.Output<outputs.apimanagement.CustomDomainManagement[] | undefined>;
    /**
     * One or more `portal` blocks as defined below.
     */
    readonly portals: pulumi.Output<outputs.apimanagement.CustomDomainPortal[] | undefined>;
    /**
     * One or more `scm` blocks as defined below.
     */
    readonly scms: pulumi.Output<outputs.apimanagement.CustomDomainScm[] | undefined>;
    /**
