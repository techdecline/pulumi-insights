...
export declare class Frontdoor extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorState, opts?: pulumi.CustomResourceOptions): Frontdoor;
    /**
     ...
     */
    readonly backendPoolHealthProbes: pulumi.Output<outputs.frontdoor.FrontdoorBackendPoolHealthProbe[]>;
    /**
     * A map/dictionary of Backend Pool Health Probe Names (key) to the Backend Pool Health Probe ID (value)
     */
    readonly backendPoolHealthProbesMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * A map/dictionary of Backend Pool Load Balancing Setting Names (key) to the Backend Pool Load Balancing Setting ID (value)
     */
    readonly backendPoolLoadBalancingSettingsMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * A `backendPoolLoadBalancing` block as defined below.
     */
    readonly backendPoolLoadBalancings: pulumi.Output<outputs.frontdoor.FrontdoorBackendPoolLoadBalancing[]>;
    /**
     ...
     */
    readonly backendPools: pulumi.Output<outputs.frontdoor.FrontdoorBackendPool[]>;
    /**
     * A map/dictionary of Backend Pool Names (key) to the Backend Pool ID (value)
     */
    readonly backendPoolsMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
    ...
    readonly explicitResourceOrders: pulumi.Output<outputs.frontdoor.FrontdoorExplicitResourceOrder[]>;
    /**
     ...
     */
    readonly frontendEndpoints: pulumi.Output<outputs.frontdoor.FrontdoorFrontendEndpoint[]>;
    /**
     * A map/dictionary of Frontend Endpoint Names (key) to the Frontend Endpoint ID (value)
     */
    readonly frontendEndpointsMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * The unique ID of the Front Door which is embedded into the incoming headers `X-Azure-FDID` attribute and maybe used to filter traffic sent by the Front Door to your backend.
     */
    readonly headerFrontdoorId: pulumi.Output<string>;
    /**
     * Should the Front Door Load Balancer be Enabled? Defaults to `true`.
     */
    readonly loadBalancerEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly routingRules: pulumi.Output<outputs.frontdoor.FrontdoorRoutingRule[]>;
    /**
     * A map/dictionary of Routing Rule Names (key) to the Routing Rule ID (value)
     */
    readonly routingRulesMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
...
export interface FrontdoorState {
     ...
     * A map/dictionary of Backend Pool Health Probe Names (key) to the Backend Pool Health Probe ID (value)
     */
    backendPoolHealthProbesMap?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * A map/dictionary of Backend Pool Load Balancing Setting Names (key) to the Backend Pool Load Balancing Setting ID (value)
     */
    backendPoolLoadBalancingSettingsMap?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * A `backendPoolLoadBalancing` block as defined below.
     ...
     * A map/dictionary of Frontend Endpoint Names (key) to the Frontend Endpoint ID (value)
     */
    frontendEndpointsMap?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * The unique ID of the Front Door which is embedded into the incoming headers `X-Azure-FDID` attribute and maybe used to filter traffic sent by the Front Door to your backend.
