 ...
 * ```
 */
export declare class LinkedServiceSynapse extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceSynapseState, opts?: pulumi.CustomResourceOptions): LinkedServiceSynapse;
    /**
     * Returns true if the given object is an instance of LinkedServiceSynapse.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LinkedServiceSynapse;
    /**
