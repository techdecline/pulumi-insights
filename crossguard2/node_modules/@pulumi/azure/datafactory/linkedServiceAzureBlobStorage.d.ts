...
export declare class LinkedServiceAzureBlobStorage extends pulumi.CustomResource {
     ...
     */
    readonly connectionStringInsecure: pulumi.Output<string | undefined>;
    /**
    ...
    readonly servicePrincipalLinkedKeyVaultKey: pulumi.Output<outputs.datafactory.LinkedServiceAzureBlobStorageServicePrincipalLinkedKeyVaultKey | undefined>;
    readonly storageKind: pulumi.Output<string | undefined>;
