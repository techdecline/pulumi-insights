 ...
 * ```
 */
export declare class DatasetAzureSqlTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatasetAzureSqlTableState, opts?: pulumi.CustomResourceOptions): DatasetAzureSqlTable;
    /**
     * Returns true if the given object is an instance of DatasetAzureSqlTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatasetAzureSqlTable;
    /**
     ...
     */
    readonly linkedServiceId: pulumi.Output<string>;
    /**
     ...
     */
    readonly schemaColumns: pulumi.Output<outputs.datafactory.DatasetAzureSqlTableSchemaColumn[] | undefined>;
    /**
