 ...
 * ```
 */
export declare class CustomDataset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomDatasetState, opts?: pulumi.CustomResourceOptions): CustomDataset;
    /**
     * Returns true if the given object is an instance of CustomDataset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomDataset;
    /**
     ...
     */
    readonly schemaJson: pulumi.Output<string | undefined>;
    /**
