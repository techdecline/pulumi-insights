 ...
 * ```
 */
export declare function getTriggerSchedule(args: GetTriggerScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetTriggerScheduleResult>;
/**
 ...
 * ```
 */
export declare function getTriggerScheduleOutput(args: GetTriggerScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTriggerScheduleResult>;
/**
 * A collection of arguments for invoking getTriggerSchedule.
 */
