 ...
 * ```
 */
export declare class LinkedServiceAzureSearch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceAzureSearchState, opts?: pulumi.CustomResourceOptions): LinkedServiceAzureSearch;
    /**
     * Returns true if the given object is an instance of LinkedServiceAzureSearch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LinkedServiceAzureSearch;
    /**
     ...
     */
    readonly searchServiceKey: pulumi.Output<string>;
    /**
