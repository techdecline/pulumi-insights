 ...
 * ```
 */
export declare class LinkedServiceAzureFunction extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceAzureFunctionState, opts?: pulumi.CustomResourceOptions): LinkedServiceAzureFunction;
    /**
     ...
     */
    static isInstance(obj: any): obj is LinkedServiceAzureFunction;
    /**
