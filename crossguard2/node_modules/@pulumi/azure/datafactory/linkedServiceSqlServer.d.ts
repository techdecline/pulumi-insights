 ...
 * ```
 */
export declare class LinkedServiceSqlServer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceSqlServerState, opts?: pulumi.CustomResourceOptions): LinkedServiceSqlServer;
    /**
     * Returns true if the given object is an instance of LinkedServiceSqlServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LinkedServiceSqlServer;
    /**
     ...
     */
    readonly keyVaultConnectionString: pulumi.Output<outputs.datafactory.LinkedServiceSqlServerKeyVaultConnectionString | undefined>;
    /**
