 ...
 * ```
 */
export declare class LinkedServiceAzureTableStorage extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceAzureTableStorageState, opts?: pulumi.CustomResourceOptions): LinkedServiceAzureTableStorage;
    /**
     ...
     */
    static isInstance(obj: any): obj is LinkedServiceAzureTableStorage;
    /**
