 ...
 * ```
 */
export declare class LinkedServiceCosmosDb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceCosmosDbState, opts?: pulumi.CustomResourceOptions): LinkedServiceCosmosDb;
    /**
     * Returns true if the given object is an instance of LinkedServiceCosmosDb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LinkedServiceCosmosDb;
    /**
     * The endpoint of the Azure CosmosDB account. Required if `connectionString` is unspecified.
     */
    readonly accountEndpoint: pulumi.Output<string | undefined>;
    /**
