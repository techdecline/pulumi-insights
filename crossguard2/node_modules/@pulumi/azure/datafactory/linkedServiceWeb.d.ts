 ...
 * ```
 */
export declare class LinkedServiceWeb extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkedServiceWebState, opts?: pulumi.CustomResourceOptions): LinkedServiceWeb;
    /**
     * Returns true if the given object is an instance of LinkedServiceWeb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LinkedServiceWeb;
    /**
