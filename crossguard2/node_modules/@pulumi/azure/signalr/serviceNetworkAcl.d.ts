 ...
 * ```
 */
export declare class ServiceNetworkAcl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceNetworkAclState, opts?: pulumi.CustomResourceOptions): ServiceNetworkAcl;
    /**
     * Returns true if the given object is an instance of ServiceNetworkAcl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceNetworkAcl;
    /**
     ...
     */
    readonly privateEndpoints: pulumi.Output<outputs.signalr.ServiceNetworkAclPrivateEndpoint[] | undefined>;
    /**
     * A `publicNetwork` block as defined below.
     */
    readonly publicNetwork: pulumi.Output<outputs.signalr.ServiceNetworkAclPublicNetwork>;
    /**
