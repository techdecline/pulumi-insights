 ...
 * ```
 */
export declare function getDateTimeVariable(args: GetDateTimeVariableArgs, opts?: pulumi.InvokeOptions): Promise<GetDateTimeVariableResult>;
/**
 ...
 * ```
 */
export declare function getDateTimeVariableOutput(args: GetDateTimeVariableOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDateTimeVariableResult>;
/**
 * A collection of arguments for invoking getDateTimeVariable.
 */
