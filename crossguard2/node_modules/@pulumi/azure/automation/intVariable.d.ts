 ...
 * ```
 */
export declare class IntVariable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IntVariableState, opts?: pulumi.CustomResourceOptions): IntVariable;
    /**
     * Returns true if the given object is an instance of IntVariable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IntVariable;
    /**
