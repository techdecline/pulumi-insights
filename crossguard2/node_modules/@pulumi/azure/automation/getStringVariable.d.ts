 ...
 * ```
 */
export declare function getStringVariableOutput(args: GetStringVariableOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStringVariableResult>;
/**
 * A collection of arguments for invoking getStringVariable.
 */
