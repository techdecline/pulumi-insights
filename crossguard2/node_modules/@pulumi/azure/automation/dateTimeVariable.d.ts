 ...
 * ```
 */
export declare class DateTimeVariable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DateTimeVariableState, opts?: pulumi.CustomResourceOptions): DateTimeVariable;
    /**
     * Returns true if the given object is an instance of DateTimeVariable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DateTimeVariable;
    /**
