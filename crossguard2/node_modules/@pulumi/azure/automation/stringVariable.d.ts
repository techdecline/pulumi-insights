 ...
 * ```
 */
export declare class StringVariable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StringVariableState, opts?: pulumi.CustomResourceOptions): StringVariable;
    /**
     * Returns true if the given object is an instance of StringVariable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StringVariable;
    /**
