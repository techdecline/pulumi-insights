 ...
 * ```
 */
export declare class VariableObject extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VariableObjectState, opts?: pulumi.CustomResourceOptions): VariableObject;
    /**
     * Returns true if the given object is an instance of VariableObject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VariableObject;
    /**
