 ...
 */
export declare class PortalDashboard extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PortalDashboardState, opts?: pulumi.CustomResourceOptions): PortalDashboard;
    /**
     * Returns true if the given object is an instance of PortalDashboard.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PortalDashboard;
    /**
     * JSON data representing dashboard body. See above for details on how to obtain this from the Portal.
     */
    readonly dashboardProperties: pulumi.Output<string>;
    /**
