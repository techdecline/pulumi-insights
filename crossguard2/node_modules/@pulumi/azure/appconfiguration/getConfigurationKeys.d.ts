 ...
 * ```
 */
export declare function getConfigurationKeys(args: GetConfigurationKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationKeysResult>;
/**
 ...
 * ```
 */
export declare function getConfigurationKeysOutput(args: GetConfigurationKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConfigurationKeysResult>;
/**
 * A collection of arguments for invoking getConfigurationKeys.
 */
