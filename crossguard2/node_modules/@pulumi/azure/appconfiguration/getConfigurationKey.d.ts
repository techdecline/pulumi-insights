 ...
 * ```
 */
export declare function getConfigurationKeyOutput(args: GetConfigurationKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConfigurationKeyResult>;
/**
 * A collection of arguments for invoking getConfigurationKey.
 */
