...
export declare class SqlPoolWorkloadGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlPoolWorkloadGroupState, opts?: pulumi.CustomResourceOptions): SqlPoolWorkloadGroup;
    /**
     ...
     */
    readonly minResourcePercentPerRequest: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly queryExecutionTimeoutInSeconds: pulumi.Output<number | undefined>;
    /**
