 ...
 * ```
 */
export declare function getFrontdoorEndpoint(args: GetFrontdoorEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetFrontdoorEndpointResult>;
/**
 ...
 * ```
 */
export declare function getFrontdoorEndpointOutput(args: GetFrontdoorEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFrontdoorEndpointResult>;
/**
 * A collection of arguments for invoking getFrontdoorEndpoint.
 */
