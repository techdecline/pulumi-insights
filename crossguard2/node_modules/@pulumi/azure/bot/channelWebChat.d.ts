 ...
 * ```
 */
export declare class ChannelWebChat extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ChannelWebChatState, opts?: pulumi.CustomResourceOptions): ChannelWebChat;
    /**
     * Returns true if the given object is an instance of ChannelWebChat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ChannelWebChat;
    /**
     ...
     */
    readonly sites: pulumi.Output<outputs.bot.ChannelWebChatSite[] | undefined>;
    /**
