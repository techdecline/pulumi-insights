 ...
 * ```
 */
export declare class ChannelDirectLine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ChannelDirectLineState, opts?: pulumi.CustomResourceOptions): ChannelDirectLine;
    /**
     * Returns true if the given object is an instance of ChannelDirectLine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ChannelDirectLine;
    /**
     ...
     */
    readonly sites: pulumi.Output<outputs.bot.ChannelDirectLineSite[]>;
    /**
