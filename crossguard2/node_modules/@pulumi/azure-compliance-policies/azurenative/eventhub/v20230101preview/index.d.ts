...
export { Cluster };
declare namespace ConsumerGroup {
    /**
...
declare namespace DisasterRecoveryConfig {
    /**
...
export { EventHub };
declare namespace EventHubAuthorizationRule {
    /**
...
export { EventHubAuthorizationRule };
...
declare namespace NamespaceNetworkRuleSet {
    /**
...
export { NamespaceNetworkRuleSet };
