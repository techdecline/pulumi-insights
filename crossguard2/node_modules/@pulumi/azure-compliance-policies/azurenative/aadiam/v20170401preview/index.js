...
const v20170401preview_1 = require("@pulumi/azure-native/aadiam/v20170401preview");
...
(function (DiagnosticSetting) {
     ...
     */
    DiagnosticSetting.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20170401preview_1.DiagnosticSetting, (_, args, reportViolation) => {
