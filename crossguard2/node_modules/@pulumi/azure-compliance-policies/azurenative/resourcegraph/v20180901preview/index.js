...
const v20180901preview_1 = require("@pulumi/azure-native/resourcegraph/v20180901preview");
var GraphQuery;
(function (GraphQuery) {
    /**
     ...
     */
    GraphQuery.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20180901preview_1.GraphQuery, (_, args, reportViolation) => {
