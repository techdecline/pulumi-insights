...
const v20220501preview_1 = require("@pulumi/azure-native/dbforpostgresql/v20220501preview");
var Migration;
(function (Migration) {
    /**
    ...
    Migration.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20220501preview_1.Migration, (_, args, reportViolation) => {
