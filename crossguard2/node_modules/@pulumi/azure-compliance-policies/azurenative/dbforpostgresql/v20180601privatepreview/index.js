...
const v20180601privatepreview_1 = require("@pulumi/azure-native/dbforpostgresql/v20180601privatepreview");
...
(function (PrivateEndpointConnection) {
    ...
    PrivateEndpointConnection.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20180601privatepreview_1.PrivateEndpointConnection, (_, args, reportViolation) => {
                if (!compliance_policy_manager_1.policyManager.shouldEvalPolicy(args)) {
                    return;
                }
                reportViolation("Azure PrivateEndpointConnection shouldn't use an unstable API (dbforpostgresql.v20180601privatepreview.PrivateEndpointConnection). A compatible replacement can be found at 'dbforpostgresql.PrivateEndpointConnection'.");
            }),
        },
        vendors: ["azure"],
