...
const v20231101preview_1 = require("@pulumi/azure-native/hdinsight/v20231101preview");
const v20231101preview_2 = require("@pulumi/azure-native/hdinsight/v20231101preview");
var Cluster;
(function (Cluster) {
    /**
    ...
    Cluster.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20231101preview_1.Cluster, (_, args, reportViolation) => {
...
(function (ClusterPool) {
    ...
    ClusterPool.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            configSchema: compliance_policy_manager_1.policyManager.policyConfigSchema,
            enforcementLevel: "advisory",
            validateResource: (0, policy_1.validateResourceOfType)(v20231101preview_2.ClusterPool, (_, args, reportViolation) => {
                if (!compliance_policy_manager_1.policyManager.shouldEvalPolicy(args)) {
                    return;
                }
