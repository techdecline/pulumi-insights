...
exports.ManagedCCF = exports.Ledger = void 0;
const policy_1 = require("@pulumi/policy");
const compliance_policy_manager_1 = require("@pulumi/compliance-policy-manager");
const v20230628preview_1 = require("@pulumi/azure-native/confidentialledger/v20230628preview");
const v20230628preview_2 = require("@pulumi/azure-native/confidentialledger/v20230628preview");
var Ledger;
(function (Ledger) {
    /**
     ...
     */
    Ledger.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(v20230628preview_1.Ledger, (_, args, reportViolation) => {
...
(function (ManagedCCF) {
     ...
     * @link https://learn.microsoft.com/en-us/rest/api/azure/
     */
    ManagedCCF.disallowPreviewResource = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            configSchema: compliance_policy_manager_1.policyManager.policyConfigSchema,
            enforcementLevel: "advisory",
            validateResource: (0, policy_1.validateResourceOfType)(v20230628preview_2.ManagedCCF, (_, args, reportViolation) => {
                if (!compliance_policy_manager_1.policyManager.shouldEvalPolicy(args)) {
                    return;
                }
                reportViolation("Azure ManagedCCF shouldn't use an unstable API (confidentialledger.v20230628preview.ManagedCCF). A compatible replacement can be found at 'confidentialledger.ManagedCCF'.");
            }),
        },
        vendors: ["azure"],
        services: ["confidentialledger"],
